  ...
  return (
    <div className="w-full fixed z-40">
      ...
      >
        ...
        "
        >
          <NavbarItems lable="Home" />
          <NavbarItems lable="Series" />
          <NavbarItems lable="Films" />
          <NavbarItems lable="New & Popular" />
          <NavbarItems lable="My List" />
          <NavbarItems lable="Browse by languages" />
        </div>
